...
<FormLabel sx={{ fontSize: '0.75rem', fontWeight: 'bold', fontFamily: 'Almarai' }}>{label}</FormLabel>
...
label={<Typography sx={{ fontSize: '0.8rem', fontFamily: 'Almarai' }}>{opt.l}</Typography>}
...
setPackagingCost(storeOrder.PackagingCost || "0");

setIsFragile(storeOrder.Fragile || "0");

setCanOpen(storeOrder.CanOpen || "0");

setOrderItems(storeOrder.Item.map((it) => ({
...
<RadioField label="تبريد" value={isCooling} onChange={setIsCooling} options={[{v:"0", l:"لا"}, {v:"1", l:"نعم"}]} disabled={preventUpdate} />

</Grid>

<Grid item xs={4}>

<RadioField label="كسر" value={isFragile} onChange={setIsFragile} options={[{v:"0", l:"لا"}, {v:"1", l:"نعم"}]} disabled={preventUpdate} />

</Grid>

<Grid item xs={4}>

<RadioField label="فتح الطرد" value={canOpen} onChange={setCanOpen} options={[{v:"0", l:"لا"}, {v:"1", l:"نعم"}]} disabled={preventUpdate} />
...
onChange={setIsPackaging}

options={[{v:"0", l:"المرسل"}, {v:"1", l:"المستلم"}]}
